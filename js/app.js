...
const heightImage = image2.offsetHeight;
  ...
  window.addEventListener("scroll", () => {
    ...
    if (scrollTop > initPoint) {
      ...
      if (percent <= 70) {
        ...
        image.style.transform = `translateY(${movement + (heightImage / 3)}px) translateX(-${110 - percent}vw)`;
        ...
        boxEnd.style.transition = '1s opacity ease-in-out'
